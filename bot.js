...
client.on("ready", () => {
  client.user.setGame(prefix + `yardım | ` + client.guilds.size + ` adet sunucuya ve ` + client.guilds.reduce((a, b) => a + b.memberCount, 0).toLocaleString() + ` kullanıcıya hizmet veriliyor! | Davet etmek için k!davet | p!destekgrup `) 
